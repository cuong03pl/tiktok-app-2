...
export const PeopleIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const PeopleIconActive = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const VerifyIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const QRIcon = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg
            width={width}
            height={height}
